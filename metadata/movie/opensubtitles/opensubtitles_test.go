...
// patchBaseURL temporarily replaces the base URL for testing.
// Since baseURL is a const, we wrap requests through a reverse proxy.
...
func TestWithUserAgent(t *testing.T) {
	c := New("key", WithUserAgent("myapp v2.0"))
